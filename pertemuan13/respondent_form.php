  ...
  <div class="content-wrapper">
    ...
    ?>
      ...
      <div class="card">
        ...
        <div class="card-body">
            <form action="respondent_action.php?act=simpan" method="post">
                ...
                <div class="form-group">
                    ...
                    <a href="respondent.php" class="btn btn-warning">Kembali</a>
                </div>
            </form>
        </div>
      </div>
    ...
    <?php  } else if($action == 'edit'){ ?>
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form action="respondent_action.php?act=edit" method="post">
                <div class="form-group">
                    <label for="soal">Kode Soal</label>
                    <input name="kode_soal" class="form-control" required>
                </div>
