      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="bank_soal_action.php?act=simpan" method="post" id="form-tambah">
            <div class="form-group">
              ...
              <input required type="text" name="kode_soal" id="kode_soal" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" name="simpan" class="btn btn-primary" value="simpan cuy">Simpan</button>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="bank_soal_action.php?act=edit&id=<?php echo $id?>" method="post">
              <div class="form-group">
                <label for="kode_soal">Kode Soal</label>
